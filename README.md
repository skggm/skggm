...
Given **n** independently drawn, **p**-dimensional Gaussian random samples **X \in R^{n, p}**, the maximum likelihood estimate of the inverse covariance matrix **S** can be computed via the _graphical lasso_, i.e., the program
