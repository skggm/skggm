...
_Manjari, maybe we want to use one of the other methods in this example instead of the straight up QuicGraphLasso since we have many estimators to choose from?  I've tried QuicGraphLassoCV, the results are above_
